...
Windows for the Air Quality extension:
  * AirQualityPanel   - the Preferences page: the place (one from Preferences,
                        Places, or its own city, found with the city search),
                        the unhealthy-air announcement, notes, attribution.
...
class AirQualityPanel(_PageBase):
    ...
    def __init__(self, parent, settings):
        ...
        for note in (_("note_index"), _("note_area"), _("note_tips"), _("note_privacy"),
                     _("attribution")):
