...
def test_command_bar_window(tmp_path):
    env = dict(os.environ, APPDATA=str(tmp_path), PYTHONIOENCODING="utf-8")
    result = subprocess.run(
        [sys.executable, os.path.join(ROOT, "tests", "_command_bar_ui_check.py")],
    ...
    for stage in ("OK main_window", "OK action", "OK bar", "OK command", "OK did_you_mean",
                  ...
                  "OK escape", "OK time", "OK keep_open", "OK hidden_main_window", "OK intents", "OK background", "OK no_errors", "OK shutdown"):
