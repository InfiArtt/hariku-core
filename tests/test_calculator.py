...
OTHER_SENTENCES = [
    ...
    "orbit go to the cantina", "orbit give Sari 50 credits", "orbit buy 2 coffee", "open orbit",
    "orbit who is online",
    # Hariku's own
...
@pytest.mark.parametrize("text, owner", [
    ...
    ("orbit give Sari 50 credits", "Orbit.play"), ("jam berapa", "Hariku Core.speak_time"),
