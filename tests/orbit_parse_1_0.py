...
"""
A frozen copy of Orbit 1.0's command reader (extensions/orbit/orbit_parse.py
as published in the Extension Store), kept only so tests/test_orbit_compat.py
can check that everything the server learned later still works for players
who haven't updated. Don't change it.
